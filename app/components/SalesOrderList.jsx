...
const SalesOrderList = (props) => {
  ...
  //assigns 1 as the default number of orders for each instance of a product in the orderList
  ...
  const handleQtyChange = (index, event) => {
    ...
    newOrderList[index].quantity = event.target.valueAsNumber;
  ...
  const handleRemove = (index) => {
    ...
    const newQtyValues = qtyValues
      .slice(0, index)
      .concat(qtyValues.slice(index + 1));
